...
* data.getSchedulesContextOp.behandlare 0..* Behandlare "List of practitioners."
* data.getSchedulesContextOp.behandlingstyper 0..* Behandlingstyper "List of procedures."
