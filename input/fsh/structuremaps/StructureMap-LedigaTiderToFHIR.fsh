Instance: flc-ledigatider
InstanceOf: FLCStructureMap
Usage: #definition
* name = "flc-ledigatider"
* id = "flc-ledigatider"
* version = "0.1.0"
* title = "FLC LedigaTider"
* status = #draft
* experimental = true
* date = "2026-07-14"
...
* structure[+].url = Canonical(lediga-tider-payload)
...
* group.typeMode = #none
* group.documentation = "Almasoft LedigaTider to FHIR via Liquid template."
* group.input.name = "LedigaTiderPayload"
...
* group.rule.target.extension[FhirLiquidMap].extension[liquidTemplate].valueString = "LedigaTider.liquid"
